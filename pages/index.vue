  ...
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
      ...
      <DashboardKpiCard
        ...
        :icon-bg-class="saldoMes >= 0 ? 'bg-controle-50' : 'bg-red-50'"
        :icon-color-class="saldoMes >= 0 ? 'text-controle-600' : 'text-red-600'"
        :accent-gradient="saldoMes >= 0 ? 'bg-gradient-to-r from-controle-400 to-controle-600' : 'bg-gradient-to-r from-red-400 to-red-600'"
        :value-color-class="saldoMes >= 0 ? 'text-controle-600' : 'text-red-600'"
      >
        <!-- Barras proporcionais -->
        <div class="space-y-1.5">
          <div class="flex items-center gap-2">
            <span class="text-[10px] text-operacao-400 w-12">Entradas</span>
            <div class="flex-1 bg-operacao-100 rounded-full h-1.5">
              <div
          ...
          <div class="flex items-center gap-2">
            <span class="text-[10px] text-operacao-400 w-12">Saídas</span>
            <div class="flex-1 bg-operacao-100 rounded-full h-1.5">
              <div
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
      ...
      <UCard class="lg:col-span-7" :ui="cardUi">
        <template #header>
          <div class="flex items-center justify-between">
            <h3 class="text-base font-semibold text-operacao-800">Evolução do CMV %</h3>
      ...
      <UCard class="lg:col-span-5" :ui="cardUi">
        <template #header>
          <h3 class="text-base font-semibold text-operacao-800">Distribuição ABC</h3>
        </template>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <UCard :ui="cardUi">
        <template #header>
          <h3 class="text-base font-semibold text-operacao-800">Ações Rápidas</h3>
        </template>
        ...
        <div class="space-y-4">
          ...
          <div class="flex items-center justify-between p-3 bg-operacao-50 rounded-lg">
            <div class="flex items-center gap-2">
              <UIcon name="i-heroicons-calendar" class="w-4 h-4 text-operacao-400" />
              <span class="text-xs text-operacao-400">{{ mesAtual }}</span>
            </div>
      ...
      <template #header>
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-3">
            ...
            <div>
              <h3 class="text-base font-semibold text-operacao-800">Alertas de Reposição</h3>
              <p class="text-xs text-operacao-400">Produtos que precisam de compra urgente</p>
            </div>
          </div>
